...
```{r setvariables}
dataLoc <- "../Temp/Data-Science-Specialization-Capstone-Data/Sampled/"
...
create.sampled.file <- function(inputFile, outputFile, fraction = 0.1) {
...
#create.sampled.file("../Temp/Data-Science-Specialization-Capstone-Data/en_US.news.txt","../Temp/Data-Science-Specialization-Capstone-Data/Sampled/en_US.news_Sampled.txt", fraction = 0.001)
